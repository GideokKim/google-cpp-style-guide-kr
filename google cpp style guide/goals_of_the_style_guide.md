...
스타일 가이드의 목표는 규칙을 외우게 하려는 것이 아니라, 왜 그런 규칙이 필요한지 판단할 기준을 제공하는 것입니다. 규칙이 충돌하거나 예외가 필요해 보일 때도 이 목표들을 기준으로 생각하면 더 일관된 결정을 내릴 수 있습니다.

핵심은 독자 최적화, 일관성, 위험한 구조 회피, 대규모 코드베이스에서의 비용 절감입니다. 개인 취향보다 공동 유지보수 비용을 줄이는 방향을 선택하는 것이 이 문서의 중심입니다.
